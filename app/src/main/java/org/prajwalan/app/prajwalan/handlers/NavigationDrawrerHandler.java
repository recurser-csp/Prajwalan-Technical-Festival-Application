...
import org.prajwalan.app.prajwalan.g2lc;
        ...
        switch (d.getId()) {
           ...
           */ case R.id.nav_about :               i = new Intent(context, About.class);
            ...
            case R.id.nav_developer :           i = new Intent(context, developer.class);
                                                context.startActivity(i);
                                                break;
            case R.id.iwhatt :                  String number = "8446992115";
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Date futureDate = dateFormat.parse("2017-03-09 08:00:00");
